...
world.taxonomy %>% 
  write_rds(here("analysis", "classifiers_to_use_in_insect", "new.taxonomy.20210723.rds"))
```
...
New.new.seqs %>% 
  writeFASTA(file = here(here("analysis", "classifiers_to_use_in_insect", "insect_classifiers", "12S", "Only_with_taxID.fasta")))
