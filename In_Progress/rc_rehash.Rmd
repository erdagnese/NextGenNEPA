...
hash_key <- read.csv(here("Output","dada2_output_files", "run2_rerun_20211013", "COI_bkwds_200_175_hash_key.csv"))
asv_table <- read.csv(here("Output","dada2_output_files", "run2_rerun_20211013", "COI_bkwds_200_175_ASV_table.csv"))
```
...
write.csv(new_hash_key, here("Output","dada2_output_files", "run2_rerun_20211013", "COI_bkwds_200_175_new_hash_key.csv"))
...
write.csv(new_asv_table, here("Output","dada2_output_files", "run2_rerun_20211013", "COI_bkwds_200_175_new_ASV_table.csv"))
