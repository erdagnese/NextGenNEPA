...
params: 
  folder:
    value: C:\Users\erdag\github\NextGenNEPA\Output\hashes_to_taxonomy_output\run2_rerun_crux\MiX 
  Hash_key:
    value: C:\Users\erdag\github\NextgenNEPA\Output\dada2_output_files\run2_rerun_20211011\MiX_hash_key.csv
  ASVs: 
...
previous.effort <- read_rds(here("Ouput","hashes_to_taxonomy_output", "20210802_MiFish_prev_hashes.annotated.rds"))
```
