...
params: 
  folder:
    value: C:\Users\erdag\NextGenNEPA_local\insect_output_files\run2_rerun_crux_20211008 
  Hash_key:
    value: C:\Users\erdag\github\NextgenNEPA\Output\dada2_output_files\run2_rerun_20211008\MiFish_hash_key.csv
  ASVs: 
    value: C:\Users\erdag\github\NextgenNEPA\Output\dada2_output_files\run2_rerun_20211008\MiFish_ASV_table.csv
  classifier:
    value: C:\Users\erdag\NextGenNEPA_local\classifiers\classifier_12S_MiFish.rds  
...
previous.effort <- read_rds(here("NextGenNEPA_local", "insect_output_files", "12S_testrun", "hashes.annotated.rds"))
...
now we want to make a tax.table for use in the phyloseq object
```{r using tax.table.R to make a tax table}
#need to make this line not contigent on local directory
source(here("github","NextGenNEPA","functions", "tax.table.R"))

taxtable <- tax.table(clasif.hashes)
#make this a save as rds and save it in the github output folder 
write.csv(taxtable, "taxtable.csv")#save it in the local directory for any future needs
```
