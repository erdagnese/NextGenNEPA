...
params: 
  folder:
    value: C:\Users\erdag\github\NextGenNEPA\Output\hashes_to_taxonomy_output\run2_rerun\COI\COI_fwds 
  Hash_key:
    value: C:\Users\erdag\github\NextGenNEPA\Output\dada2_output_files\run2_rerun_20211013\COI_fwds_hash_key.csv
  ASVs: 
    value: C:\Users\erdag\github\NextGenNEPA\Output\dada2_output_files\run2_rerun_20211013\COI_fwds_ASV_table.csv
  classifier:
...
thresholds.classif <- map(thresholds, ~ classify(x= all.has
                                                 hes.insect,
                                              tree = tree.2,
                                              cores = 4,
                                              threshold = .))
