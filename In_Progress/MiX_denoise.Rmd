...
metadata <- read.csv(here("Output", "dada2_output_files", "MiX.all.metadata.csv"))
ASV.table <- read.csv(here("Output", "dada2_output_files", "MiX.merged.ASV.table.csv"))
...
ASV.nested %>% 
  transmute(Summary = map(sample, ~ how.many(ASVtable = ASV.table,round = 0)))  -> ASV.summary
```
