...
params:
  folder:
    value: C:\Users\erdag\github\NextGenNEPA\Output\phyloseq_output\run2_rerun\COI\COI_fwds 
  hashes.annotated:
    value: C:\Users\erdag\github\NextGenNEPA\Output\hashes_to_taxonomy_output\run2_rerun\COI\COI_fwds\2021-10-14taxtable.csv
  ASV: 
...
#generate a mapping dataframe with the Seq_number and hash ids to keep 
map.taxon <- data.frame(tmp.hash, tmp.tx)
