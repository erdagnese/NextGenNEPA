...
```{r}
tax.input <- read_rds(here("Output","hashes_to_taxonomy_output", "rerun_2_crux", "MiFish", "hashes.annotated.rds"))
asv.mat <- read_csv(here("Output", "dada2_output_files", "run2_rerun_20211008", "MiFish_ASV_table.csv"))
metadata <- read_csv(here("Output", "dada2_output_files", "run2_rerun_20211008", "MiFish_metadata.csv"))
```
